return {
    ...
    ["Auto Get Sofa"] = {
        ["en"] = "Auto Get Sofa",
        ["ar"] = "الحصول على الأريكة تلقائيًا",
    ...
    ["Notify when player leaves/joins"] = {
        ...
        ["ar"] = "الإشعار عند دخول/مغادرة اللاعب",
    ...
    ["Auto Close/Open Garage Door"] = {
        ...
        ["ar"] = "إغلاق/فتح باب الكراج تلقائيًا",
    ...
    ["Enter the Audio or Music ID "] = {
        ...
        ["ar"] = "أدخل معرف الصوت أو الموسيقى ",
    ...
    ["Everyone on the server hears the audio"] = {
        ...
        ["ar"] = "الجميع في السيرفر يسمع الصوت",
    ...
    ["This will take some sec for loading"] = {
        ...
        ["ar"] = "قد يأخذ من بعض وقت لفتح السكربت",
