return {
    ...
    ["You already have a Gun/Revolver!"] = {
        ["en"] = "You already have a Gun/Revolver!",
        ["ar"] = "أنت تمتلك مسدس/ريفلفر بالفعل!",
        ["ru"] = "У вас уже есть пистолет/револьвер!",
        ["tr"] = "Zaten bir Silah/Tabancanız var!",
        ["es"] = "¡Ya tienes un arma/revólver!",
        ["fr"] = "Vous avez déjà une arme/un revolver !",
        ["de"] = "Du hast bereits eine Waffe/einen Revolver!",
        ["pt"] = "Você já tem uma Arma/Revólver!",
    },
    ["Gun grabbed successfully!"] = {
        ["en"] = "Gun grabbed successfully!",
        ["ar"] = "تم التقاط المسدس بنجاح!",
        ["ru"] = "Пистолет успешно поднят!",
        ["tr"] = "Silah başarıyla alındı!",
        ["es"] = "¡Arma recogida con éxito!",
        ["fr"] = "Arme ramassée avec succès !",
        ["de"] = "Waffe erfolgreich aufgenommen!",
        ["pt"] = "Arma coletada com sucesso!",
    },
    ["Failed to grab gun (someone else might have taken it)!"] = {
        ["en"] = "Failed to grab gun (someone else might have taken it)!",
        ["ar"] = "فشل التقاط المسدس (ربما أخذها شخص آخر)!",
        ["ru"] = "Не удалось поднять пистолет (возможно, его взял кто-то другой)!",
        ["tr"] = "Silah alınamadı (başka biri almış olabilir)!",
        ["es"] = "¡Error al recoger el arma (alguien más podría haberla tomado)!",
        ["fr"] = "Échec du ramassage (quelqu'un d'autre l'a peut-être prise) !",
        ["de"] = "Waffe konnte nicht aufgenommen werden (jemand anderes hat sie möglicherweise genommen)!",
        ["pt"] = "Falha ao pegar a arma (alguém pode ter pegado)!",
    },
    ["Mouse Aim"] = {
        ["en"] = "Mouse Aim",
        ["ar"] = "تصويب الماوس",
        ["ru"] = "Прицел мыши",
        ["tr"] = "Fare Nişanı",
        ["es"] = "Apuntado con ratón",
        ["fr"] = "Visée à la souris",
        ["de"] = "Maus-Zielen",
        ["pt"] = "Mira do Mouse",
    },
    ["Shoot Visible"] = {
        ["en"] = "Shoot Visible",
        ["ar"] = "إطلاق النار عند الظهور",
        ["ru"] = "Стрелять по видимым",
        ["tr"] = "Görünene Ateş Et",
        ["es"] = "Disparar a visibles",
        ["fr"] = "Tirer sur les visibles",
        ["de"] = "Sichtbare erschießen",
        ["pt"] = "Atirar nos visíveis",
    },
    ["Teleport & Shoot"] = {
        ["en"] = "Teleport & Shoot",
        ["ar"] = "انتقال وإطلاق النار",
        ["ru"] = "Телепорт и выстрел",
        ["tr"] = "Işınlan ve Ateş Et",
        ["es"] = "Teletransportarse y disparar",
        ["fr"] = "Téléporter et tirer",
        ["de"] = "Teleportieren & Schießen",
        ["pt"] = "Teletransportar e Atirar",
    },
    ["Teleport to Everyone"] = {
        ...
        ["ru"] = "Телепорт ко всем",
        ["tr"] = "Herkese Işınlan",
        ["es"] = "Teletransportarse a todos",
        ["fr"] = "Se téléporter vers tous",
        ["de"] = "Zu allen teleportieren",
        ["pt"] = "Teletransportar para Todos",
    },
    ["Innocents"] = {
        ["en"] = "Innocents",
        ["ar"] = "الأبرياء",
    ...
    ["Murderer is behind wall, will shoot when in front!"] = {
        ["en"] = "Murderer is behind wall, will shoot when in front!",
        ["ar"] = "القاتل وراء الحائط، سيتم إطلاق النار عندما يصبح أمامك!",
        ["ru"] = "Убийца за стеной, выстрел будет сделан, когда он появится впереди!",
        ["tr"] = "Katil duvarın arkasında, öne geçtiğinde ateş edilecek!",
        ["es"] = "¡El asesino está detrás de la pared, disparará cuando esté enfrente!",
        ["fr"] = "Le tueur est derrière le mur, il tirera lorsqu'il sera devant !",
        ["de"] = "Der Mörder ist hinter der Wand, er schießt, wenn er davor ist!",
        ["pt"] = "O assassino está atrás da parede, vai atirar quando estiver na frente!",
    },
    ["Language"] = {
        ["en"] = "Language",
        ["ar"] = "اللغة",
    ...
    ["Auto Knife Throw to Closest"] = {
        ["en"] = "Auto Knife Throw to Closest",
        ["ar"] = "رمي السكينة التلقائي لأقرب لاعب",
        ["ru"] = "Автометание ножа в ближайшего",
        ["tr"] = "En Yakına Otomatik Bıçak Fırlatma",
        ["es"] = "Lanzamiento automático de cuchillo al más cercano",
        ["fr"] = "Lancer de couteau automatique au plus proche",
        ["de"] = "Automatischer Messerwurf zum Nächsten",
        ["pt"] = "Arremesso automático de faca ao mais próximo",
    },
    ["Spawn Knife Near Target"] = {
        ["en"] = "Spawn Knife Near Target",
        ["ar"] = "توليد رمية السكينة بجانب الهدف",
        ["ru"] = "Спавнить нож рядом с целью",
        ["tr"] = "Bıçağı Hedefin Yakınında Oluştur",
        ["es"] = "Generar cuchillo cerca del objetivo",
        ["fr"] = "Faire apparaître le couteau près de la cible",
        ["de"] = "Messer in der Nähe des Ziels spawnen",
        ["pt"] = "Gerar faca perto do alvo",
    },
    ["Instant Knife Throw"] = {
        ["en"] = "Instant Knife Throw",
        ["ar"] = "رمي السكينة الفوري",
        ["ru"] = "Мгновенный бросок ножа",
        ["tr"] = "Anında Bıçak Fırlatma",
        ["es"] = "Lanzamiento instantáneo de cuchillo",
        ["fr"] = "Lancer de couteau instantané",
        ["de"] = "Sofortiger Messerwurf",
        ["pt"] = "Arremesso instantâneo de faca",
    },
    ["Show Round Timer"] = {
        ["en"] = "Show Round Timer",
        ["ar"] = "عرض عداد وقت الجولة",
        ["ru"] = "Показать таймер раунда",
        ["tr"] = "Raund Zamanlayıcısını Göster",
        ["es"] = "Mostrar temporizador de ronda",
        ["fr"] = "Afficher le minuteur de manche",
        ["de"] = "Runden-Timer anzeigen",
        ["pt"] = "Mostrar temporizador da rodada",
    },
    ["Send Roles to Chat"] = {
        ["en"] = "Send Roles to Chat",
        ["ar"] = "إرسال أسماء القاتل والشريف في الشات",
        ["ru"] = "Отправить роли в чат",
        ["tr"] = "Rolleri Chata Gönder",
        ["es"] = "Enviar roles al chat",
        ["fr"] = "Envoyer les rôles dans le tchat",
        ["de"] = "Rollen in den Chat senden",
        ["pt"] = "Enviar funções para o chat",
    },
    ["Murderer Utilities"] = {
        ["en"] = "Murderer Utilities",
        ["ar"] = "أدوات القاتل",
        ["ru"] = "Утилиты убийцы",
        ["tr"] = "Katil Araçları",
        ["es"] = "Utilidades del asesino",
        ["fr"] = "Utilitaires du tueur",
        ["de"] = "Mörder-Werkzeuge",
        ["pt"] = "Utilitários do assassino",
    },
    ["Murderer Arrow & Distance"] = {
        ["en"] = "Murderer Arrow & Distance",
        ["ar"] = "سهم ومسافة القاتل",
        ["ru"] = "Стрелка и дистанция убийцы",
        ["tr"] = "Katil Ok ve Mesafe",
        ["es"] = "Flecha y distancia del asesino",
        ["fr"] = "Flèche et distance du tueur",
        ["de"] = "Mörder-Pfeil und Entfernung",
        ["pt"] = "Seta e distância do assassino",
    },
    ["Prioritize Target: Sheriff"] = {
        ["en"] = "Prioritize Target: Sheriff",
        ["ar"] = "الأولوية على الشريف",
        ["ru"] = "Приоритет: шериф",
        ["tr"] = "Öncelikli Hedef: Şerif",
        ["es"] = "Objetivo prioritario: Alguacil",
        ["fr"] = "Cible prioritaire: Sheriff",
        ["de"] = "Prioritätsziel: Sheriff",
        ["pt"] = "Alvo prioritário: Xerife",
    },
    ["Send Murder to Chat"] = {
        ["en"] = "Send Murder to Chat",
        ["ar"] = "إرسال القاتل في الشات",
        ["ru"] = "Отправить убийцу в чат",
        ["tr"] = "Katili Chata Gönder",
        ["es"] = "Enviar asesino al chat",
        ["fr"] = "Envoyer le tueur dans le tchat",
        ["pt"] = "Enviar assassino para o chat",
    },
    ["Custom Murder Chat Message"] = {
        ["en"] = "Custom Murder Chat Message",
        ["ar"] = "تخصيص رسالة القاتل في الشات",
        ["ru"] = "Своё сообщение об убийце",
        ["tr"] = "Özel Katil Chat Mesajı",
        ["es"] = "Mensaje de chat personalizado de asesino",
        ["fr"] = "Message de tchat personnalisé du tueur",
        ["pt"] = "Mensagem de chat personalizada do assassino",
    },
    ["Custom Murder Chat Message Desc"] = {
        ["en"] = "Use [player] placeholder to automatically insert the Murderer's name (e.g. The murder is [player]). Leave blank for default.",
        ["ar"] = "استخدم المتغير [player] ليحل محله اسم القاتل تلقائياً (مثال: القاتل هو [player]). اترك المربع فارغاً للرسالة الافتراضية.",
        ["ru"] = "Используйте [player] для автозамены на имя убийцы (напр. Убийца - [player]). Оставьте пустым по умолчанию.",
        ["tr"] = "Katilin adını eklemek için [player] değişkenini kullanın (ör. Katil: [player]). Varsayılan için boş bırakın.",
        ["es"] = "Usa [player] para reemplazar con el nombre del asesino (ej. El asesino es [player]). Deja en blanco para usar el predeterminado.",
        ["fr"] = "Utilisez [player] pour insérer automatiquement le nom du tueur (ex: Le tueur est [player]). Laissez vide par défaut.",
        ["pt"] = "Use [player] para substituir pelo nome do assassino (ex: O assassino é [player]). Deixe em branco para o padrão.",
    },
    ["Throw The Knife"] = {
        ["en"] = "Throw The Knife",
        ["ar"] = "رمي السكين",
        ["ru"] = "Бросить нож",
        ["tr"] = "Bıçağı Fırlat",
        ["es"] = "Lanzar el cuchillo",
        ["fr"] = "Lancer le couteau",
        ["de"] = "Messer werfen",
        ["pt"] = "Lançar a faca",
    },
    ["Faster Knife Throw Button"] = {
        ["en"] = "Faster Knife Throw Button",
        ["ar"] = "زر رمي السكين السريع",
        ["ru"] = "Быстрая кнопка броска ножа",
        ["tr"] = "Hızlı Bıçak Fırlatma Butonu",
        ["es"] = "Botón rápido de lanzamiento de cuchillo",
        ["fr"] = "Bouton rapide de lancer de couteau",
        ["de"] = "Schneller Messer-Wurf-Button",
        ["pt"] = "Botão rápido de lançamento de faca",
    },
    ["Button positions reset to default!"] = {
        ["en"] = "Button positions reset to default!",
        ["ar"] = "تم إعادة ضبط مواضع الأزرار للوضع الافتراضي!",
        ["ru"] = "Позиции кнопок сброшены по умолчанию!",
        ["tr"] = "Buton pozisyonları varsayılana sıfırlandı!",
        ["es"] = "¡Posiciones de botones restablecidas al valor predeterminado!",
        ["fr"] = "Positions des boutons réinitialisées par défaut !",
        ["de"] = "Schaltflächenpositionen auf Standard zurückgesetzt!",
        ["pt"] = "Posições dos botões redefinidas para o padrão!",
    },
    ["Custom Murder Chat Message"] = {
        ["en"] = "Custom Murder Chat Message",
        ["ar"] = "تخصيص رسالة القاتل في الشات",
        ...
        ["es"] = "Mensaje de chat personalizado de asesino",
        ["fr"] = "Message de tchat personnalisé du tueur",
        ["de"] = "Benutzerdefinierte Mörder-Chat-Nachricht",
        ["pt"] = "Mensagem de chat personalizada do assassino",
    },
    ["Custom Murder Chat Message Desc"] = {
        ["en"] = "Use [player] placeholder to automatically insert the Murderer's name (e.g. The murder is [player]). Leave blank for default.",
        ...
        ["es"] = "Usa [player] para reemplazar con el nombre del asesino (ej. El asesino es [player]). Deja en blanco para usar el predeterminado.",
        ["fr"] = "Utilisez [player] pour insérer automatiquement le nom du tueur (ex: Le tueur est [player]). Laissez vide par défaut.",
        ["de"] = "Verwende [player] um den Namen des Mörders einzufügen (z. B. Mörder ist [player]). Leer lassen für Standard.",
        ["pt"] = "Use [player] para substituir pelo nome do assassino (ex: O assassino é [player]). Deixe em branco para o padrão.",
    },
    ["Faster Knife Throw Button"] = {
        ["en"] = "Faster Knife Throw Button",
    ...
    ["Motion Aim Visualizer For Mouse"] = {
        ["en"] = "Motion Aim Visualizer For Mouse",
        ["ar"] = "محاكي مسار الماوس",
        ["ru"] = "Визуализатор прицела мыши",
        ["tr"] = "Fare İçin Hareket Nişangahı Görselleştirici",
        ["es"] = "Visualizador de puntería para ratón",
        ["fr"] = "Visualiseur de visée pour souris",
        ["de"] = "Bewegungsziel-Visualisierer für Maus",
        ["pt"] = "Visualizador de mira para mouse",
    },
    ["Murderer"] = {
        ["en"] = "Murderer",
        ["ar"] = "قاتل",
    ...
    ["Murderer not found yet!"] = {
        ["en"] = "Murderer not found yet!",
        ["ar"] = "لم يتم العثور على القاتل بعد!",
        ["ru"] = "Убийца ещё не найден!",
        ["tr"] = "Katil henüz bulunamadı!",
        ["es"] = "¡Asesino no encontrado aún!",
        ["fr"] = "Tueur non trouvé pour le moment !",
        ["de"] = "Mörder noch nicht gefunden!",
        ["pt"] = "Assassino ainda não encontrado!",
    },
    ["Offset to Ping Multiplier"] = {
        ["en"] = "Offset to Ping Multiplier",
        ["ar"] = "مضاعف إزاحة البنج",
        ["ru"] = "Множитель пинга",
        ["tr"] = "Ping Ofset Çarpanı",
        ["es"] = "Multiplicador de ping",
        ["fr"] = "Multiplicateur de décalage de ping",
        ["de"] = "Offset-zu-Ping-Multiplikator",
        ["pt"] = "Multiplicador de deslocamento de ping",
    },
    ["ping compensation offset multiplier (Default: 1)"] = {
        ["en"] = "ping compensation offset multiplier (Default: 1)",
        ["ar"] = "مضاعف تعويض البنج (الافتراضي: 1)",
        ["ru"] = "Множитель компенсации пинга (по умолч.: 1)",
        ["tr"] = "Ping telafisi ofset çarpanı (Varsayılan: 1)",
        ["es"] = "Multiplicador de compensación de ping (Predeterminado: 1)",
        ["fr"] = "Multiplicateur de compensation de ping (Par défaut: 1)",
        ["de"] = "Ping-Kompensations-Multiplikator (Standard: 1)",
        ["pt"] = "Multiplicador de compensação de ping (Padrão: 1)",
    },
    ["Rescue platform deployed! Stand safe."] = {
        ["en"] = "Rescue platform deployed! Stand safe.",
        ["ar"] = "تم نشر منصة الإنقاذ! قف في أمان.",
        ["ru"] = "Спасательная платформа развёрнута! Стойте в безопасности.",
        ["tr"] = "Kurtarma platformu açıldı! Güvende durun.",
        ["es"] = "¡Plataforma de rescate desplegada! Permanezca seguro.",
        ["fr"] = "Plateforme de secours déployée ! Restez en sécurité.",
        ["de"] = "Rettungsplattform aufgebaut! Bleibe sicher.",
        ["pt"] = "Plataforma de resgate implantada! Fique em segurança.",
    },
    ["Send Murder to Chat"] = {
        ["en"] = "Send Murder to Chat",
        ["ar"] = "إرسال القاتل في الشات",
        ...
        ["es"] = "Enviar asesino al chat",
        ["fr"] = "Envoyer le tueur dans le tchat",
        ["de"] = "Mörder in den Chat senden",
        ["pt"] = "Enviar assassino para o chat",
    },
    ["Sent murderer to chat successfully!"] = {
        ["en"] = "Sent murderer to chat successfully!",
        ["ar"] = "تم إرسال اسم القاتل في الشات بنجاح!",
        ["ru"] = "Имя убийцы успешно отправлено в чат!",
        ["tr"] = "Katilin adı chata başarıyla gönderildi!",
        ["es"] = "¡Nombre del asesino enviado al chat con éxito!",
        ["fr"] = "Nom du tueur envoyé dans le tchat avec succès !",
        ["de"] = "Mörder erfolgreich in den Chat gesendet!",
        ["pt"] = "Nome do assassino enviado para o chat com sucesso!",
    },
    ["Sheriff"] = {
        ["en"] = "Sheriff",
        ["ar"] = "شريف",
    ...
    ["Shoot Position Offset"] = {
        ["en"] = "Shoot Position Offset",
        ["ar"] = "إزاحة إطلاق النار",
        ["ru"] = "Смещение позиции выстрела",
        ["tr"] = "Atış Pozisyonu Ofseti",
        ["es"] = "Offset de posición de disparo",
        ["fr"] = "Décalage de la position de tir",
        ["de"] = "Schuss-Positions-Offset",
        ["pt"] = "Deslocamento de posição de tiro",
    },
    ["Shoot position prediction offset (Default: 2.8)"] = {
        ["en"] = "Shoot position prediction offset (Default: 2.8)",
        ["ar"] = "مسافة إزاحة توقع الإطلاق (الافتراضي: 2.8)",
        ["ru"] = "Смещение упреждения выстрела (по умолч.: 2.8)",
        ["tr"] = "Atış pozisyonu tahmin ofseti (Varsayılan: 2.8)",
        ["es"] = "Desplazamiento de predicción de disparo (Predeterminado: 2.8)",
        ["fr"] = "Décalage de prédiction de tir (Par défaut: 2.8)",
        ["de"] = "Schusspositions-Vorhersage-Offset (Standard: 2.8)",
        ["pt"] = "Deslocamento de predição de tiro (Padrão: 2.8)",
    },
    ["Spinning"] = {
        ["en"] = "Spinning",
        ["ar"] = "الدوران في الفلينق",
        ["ru"] = "Вращение",
        ["tr"] = "Dönme",
        ["es"] = "Giro",
        ["fr"] = "Rotation",
    ...
    ["UI & Buttons"] = {
        ["en"] = "UI & Buttons",
        ["ar"] = "الأزرار والواجهة",
        ["ru"] = "Интерфейс и кнопки",
        ["tr"] = "Arayüz ve Butonlar",
        ["es"] = "Interfaz y botones",
        ["fr"] = "Interface et boutons",
        ["de"] = "Benutzeroberfläche und Schaltflächen",
        ["pt"] = "Interface e botões",
    },
    ["Auto Farm Mode"] = {
        ["en"] = "Auto Farm Mode",
        ["ar"] = "وضع التجميع",
        ["ru"] = "Режим автофермы",
        ["tr"] = "Oto Toplama Modu",
        ["es"] = "Modo de Granja Automática",
        ["fr"] = "Mode de Ferme Automatique",
        ["de"] = "Auto-Farm-Modus",
        ["pt"] = "Modo de Coleta Automática",
    },
    ["Walk Speed"] = {
        ["en"] = "Walk Speed",
        ["ar"] = "سرعة المشي",
        ...
        ["de"] = "Gehgeschwindigkeit",
        ["pt"] = "Velocidade de Caminhada",
    },
    ["Tween"] = {
        ["en"] = "Tween",
        ["ar"] = "انتقال سلس (Tween)",
        ["ru"] = "Плавное перемещение (Tween)",
        ["tr"] = "Tween (Yumuşak)",
        ["es"] = "Tween (Desplazamiento)",
        ["fr"] = "Tween",
        ["de"] = "Tween",
        ["pt"] = "Tween",
    },
